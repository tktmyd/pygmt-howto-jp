...
また，2025年現在PyGMTはいまだ活発な開発下にあります．GMTのあらゆる機能がPythonで使えて，かつそれがドキュメント化されているとまでは言い切れない状態にあります．そこで，（ごく一部ではありますが）公式にはドキュメント化されてないものの，筆者が試行錯誤的に見つけた使い方のTipsなどもこの場で紹介します．

一方，本Webサイトはマニュアルではありませんので，PyGMTやGMTのあらゆる機能を網羅することは目標としていません．また，Un*xコマンドラインの利用についてはある程度知っていることを前提としています．

本WebサイトのコードはmacOS25 TahoeとUbuntu 22.04 LTSのマシン上でMiniforgeによって[構築](./install.md)したJupyter Notebookにより動作確認しています．
