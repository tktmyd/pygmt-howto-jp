...
本WebサイトのコードはmacOS25 TahoeとUbuntu 22.04 LTSのマシン上でMiniforgeによって[構築](./install.md)したJupyter Notebookにより動作確認しています．PyGMTの開発にともない，昔は通用した書き方でも最新版では警告がでたり，あるいはエラーになることがあります．
